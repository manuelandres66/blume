...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('principal', '0004_auto_20200811_1228'),
    ]
    ...
    operations = [
        migrations.AddField(
            model_name='joya',
            name='costo',
            field=djmoney.models.fields.MoneyField(decimal_places=0, default_currency='COP', max_digits=100),
        ),
        migrations.AddField(
            model_name='joya',
            name='costo_currency',
        ...
        migrations.AddField(
            model_name='joya',
            name='tipo',
            field=models.CharField(choices=[('Arete', 'aretes'), ('Pulsera', 'pulseras'), ('Collar', 'collares'), ('Anillo', 'anillos'), ('Otro', 'otros')], default='Arete', max_length=7),
        ),
